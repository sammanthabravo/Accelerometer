...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[48] = {
	...
	{(const void *)0x960c, (ISR)0x3299}, /* 12 */
	...
	{(const void *)0x95cc, (ISR)0x7ee5}, /* 27 */
